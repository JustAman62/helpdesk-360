...
<div class="container mt-4">
    <div class="row">
        <div class="col-12 col-md-6 px-4 my-5">
            <button class="btn btn-primary w-50 m-auto" style="font-size: 25px;" onclick="location.href='addCall.php'">New Call<i class="icon-phone"></i></button>
        </div>
        <div class="col-12 col-md-6 px-4 my-5">
            <button class="btn btn-primary w-50 m-auto" data-toggle="modal" data-target="#searchModal" style="font-size: 25px;">Search For Ticket <i class="icon-search"></i></button>
        </div>
    </div>
</div>
