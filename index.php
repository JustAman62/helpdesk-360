...
<div class="container mt-4">
    <div class="row d-flex flex-justify-content-between">
        <div class="col-sm-12 col-md-4 px-4">
            <button class="btn btn-secondary btn-block home-buttons" style="min-height:10vh">Add Ticket</button>
        </div>
        <div class="col-sm-12 col-md-4 px-4">
            <button class="btn btn-secondary btn-block home-buttons" style="min-height:10vh">New Call</button>
        </div>
        <div class="col-sm-12 col-md-4 px-4">
            <button class="btn btn-secondary btn-block home-buttons" style="min-height:10vh">Search For Ticket</button>
        </div>
    </div>
</div>
