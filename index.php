    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="row d-flex ">
                ...
                <div class="col-12 px-4 my-5">
                    <button class="btn btn-secondary btn-block m-auto" data-toggle="modal" data-target="#searchModal" style="width:65%;min-height:7rem;font-size: 25px;">Search For Ticket <i class="icon-search"></i></button>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-6">
